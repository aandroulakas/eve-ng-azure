...
# If your ISP provides an IPv6 , uncomment the lines 6-8
#data "http" "pip_ipv6" {
...
# If your ISP provides an IPv6 , uncomment the lines 32-44
...
# If your ISP provides an IPv6 , uncomment the lines 61-73
